...
\newcommand{\Address}{9210 5th Street}
\newcommand{\City}{Lanham, MD 20706}
...
\ResumeHeader
  ...
  \begin{ResumeWorkSection}{Work \\ Experience}
    ...
    \WorkDate{June 2015 -- August 2015}
    \WorkItem{Designed, implemented, and tested an API to enable
  ...
  \begin{ResumeWorkSection}{}
    ...
    & \begin{WorkItemize}
        ...
        \item Completed the EbbRT clock initialization algorithm which chooses
